  ...
  return (
    <div>
      <button
        ...
        className="flex items-center gap-1 text-[#151515] text-[14px] font-medium mb-[10px] -ml-1 tracking-[-0.04em]"
      ...
      <div className="space-y-[10px] mb-6">
        <div className="space-y-[5px]">
          <label className="label-field">Email<span className="text-[#FDC500]">*</span></label>
          <input
            {...register("email")}
            type="email"
